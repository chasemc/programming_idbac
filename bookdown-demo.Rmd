...
<!--chapter:end:01_connect-to-an_existing_database.Rmd-->
...
IDBacApp::process_mzml(mzFilePaths = here::here("data", "mzxml", paste0(mz_file_name, ".mzXML")),
                       ...
                       idbac_pool = db_connection$my_new_database,
...
## Now add the rest of the mzXML files
...
<!--chapter:end:03_add_data_to_a_database.Rmd-->
